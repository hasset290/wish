...
export default function ManageGifts() {
  ...
  return (
    <DashboardLayout title="Manage Seeded Gifts" subtitle="Admin creates and edits seeded gifts in the gifts collection." links={adminLinks}>
      ...
      <section className="mt-6 card p-5">
        ...
        <p className="mt-2 text-sm text-slate-600">Admin creates and edits seeded gifts in the gifts collection.</p>
      </section>
    </DashboardLayout>
  );
}
