...
export default function ManageInvites() {
  ...
  return (
    <DashboardLayout title="Manage Invites" subtitle="Admin sees invite links and invite status." links={adminLinks}>
      ...
      <section className="mt-6 card p-5">
        ...
        <p className="mt-2 text-sm text-slate-600">Admin sees invite links and invite status.</p>
      </section>
    </DashboardLayout>
  );
}
