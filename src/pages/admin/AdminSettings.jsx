...
export default function AdminSettings() {
  ...
  return (
    <DashboardLayout title="Admin Settings" subtitle="Admin manages categories, event types, and system settings." links={adminLinks}>
      ...
      <section className="mt-6 card p-5">
        ...
        <p className="mt-2 text-sm text-slate-600">Admin manages categories, event types, and system settings.</p>
      </section>
    </DashboardLayout>
  );
}
