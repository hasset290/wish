...
export default function ManageShops() {
  ...
  return (
    <DashboardLayout title="Manage Shops" subtitle="Admin approves, rejects, or suspends shop accounts." links={adminLinks}>
      <ApprovalTable title="Approval list" rows={rows} />
      <section className="mt-6 card p-5">
        <h2 className="font-bold">What this page does</h2>
        <p className="mt-2 text-sm text-slate-600">Admin approves, rejects, or suspends shop accounts.</p>
      </section>
    </DashboardLayout>
  );
}
