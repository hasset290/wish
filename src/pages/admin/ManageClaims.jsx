...
export default function ManageClaims() {
  ...
  return (
    <DashboardLayout title="Manage Claims" subtitle="Admin sees reservations and bought gifts across all events." links={adminLinks}>
      ...
      <section className="mt-6 card p-5">
        ...
        <p className="mt-2 text-sm text-slate-600">Admin sees reservations and bought gifts across all events.</p>
      </section>
    </DashboardLayout>
  );
}
